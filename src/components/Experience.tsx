const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-16 px-4 bg-white dark:bg-gray-900 transition-colors">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-xl font-semibold dark:text-white">Technical Lead & Fullstack Developer</h3>
